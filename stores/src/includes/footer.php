                ...
                <div class="layout_item w-25 links">
                  <nav class="c-nav-tool">
                    ...
                    <ul class="c-nav-tool_list">
                      <li>
                        <a href="/collections/all" class="c-link">About Us</a>
                      </li>
      
                      <li>
                        <a href="/pages/about-us" class="c-link">Gallery</a>
                      </li>
      
                      <li>
                        <a href="/blogs/community" class="c-link">Events</a>
                      </li>
                      <li>
                        <a href="#" class="c-link">Offers</a>
                      </li>
                      <li>
